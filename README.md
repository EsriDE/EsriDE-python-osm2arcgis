...
* [ArcGIS API for Python <= 1.5.0](https://developers.arcgis.com/python/): ArcGIS API for Python must be equal or less than version 1.5.0 to work correctly with OSM2ArcGIS. For further information see this issue: https://github.com/Esri/arcgis-python-api/issues/335, install with the following Anaconda command: `conda install -c esri arcgis=1.5.0`
